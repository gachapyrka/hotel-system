...
<@common.page title="Отзыв">
    <div class="row mt-5">
        <div class="col text-center">
            <h4>Оставление отзыва:</h4>
        </div>
    </div>

    <form method="post" id="messageForm" action="/user/comment/add/${hotel.id}">
        <div class="container mt-5">
            <div class="row mt-3 align-items-center justify-content-center">
                <div class="col">
                    <div class="form-floating">
                        <input type="text" id="titleInput" name="title" class="form-control" placeholder="Заголовок">
                        <label id="titleInputLabel" for="titleInput">Введите краткий отзыв</label>
                    </div>
                </div>
            </div>
            <div class="row mt-3 align-items-center justify-content-center">
                <div class="col">
                    <textarea id="textInput" class="form-control" name="text" placeholder="Введите текст отзыва (максимум 500 символов)" required="true" rows="5"></textarea>
                </div>
            </div>
