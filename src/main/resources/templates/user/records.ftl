...
<@common.page title="Забронированные номера">
        ...
        <div class="row g-2 align-items-center justify-content-between">
            <div class="col-5">
                <div class="row g-2 align-items-center justify-content-start">
                    <div class="col-auto">
                        <a class="btn btn-primary disabled" href="/user/records">Текущие</a>
                    </div>
                    <div class="col-auto">
                        <a class="btn btn-secondary" href="/user/history">История</a>
                    </div>
                </div>
            </div>
            <div class="col-7">
            ...
            <table class="table table-striped table-hover table-sm">
                ...
                <#list records as r>
                    <tr>
                        ...
                        <td class="col-3">${r.room.roomType.hotel.name}</td>
                        <td class="col-2">${r.room.number}</td>
                        <td class="col-3">${r.room.roomType.name}</td>
    ...
    <script>
        ...
        function onSearch() {
            ...
            var request = search == null? "//localhost:8080/user/records" :
                "//localhost:8080/user/records?search="+search;
